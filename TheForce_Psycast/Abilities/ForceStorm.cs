using global::VanillaPsycastsExpanded;
using RimWorld;
...
{
    public class ForceStormMaker : Thing
    {
        ...
        public override void SpawnSetup(Map map, bool respawningAfterLoad)
        {
            ...
            this.caused = GameConditionMaker.MakeConditionPermanent(ForceDefOf.Force_ForceStormCondition);
            this.caused.conditionCauser = this;
            map.GameConditionManager.RegisterCondition(this.caused);
            this.Map.weatherManager.TransitionTo(ForceDefOf.Force_ForceStorm);
        ...
        {
            if (!this.Pawn.psychicEntropy.TryAddEntropy(.01f, this) || this.Pawn.Downed) this.Destroy();
        }
